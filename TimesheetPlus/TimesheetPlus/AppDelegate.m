...
//  TimesheetPlus
//
//  Created by Deepthi Kaligi on 23/06/2016.
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    HomeViewController *vc01 = [[HomeViewController alloc] init];
    TGLViewController *vc02 = [[TGLViewController alloc] init];
    TGLViewController *vc03 = [[TGLViewController alloc] init];
    TGLViewController *vc04 = [[TGLViewController alloc] init];

    
    
    NSArray *vcArray        = [[NSArray alloc] initWithObjects:vc01,vc02,vc03,vc04, nil];
    NSArray *titlesArray    = [[NSArray alloc] initWithObjects:@"HOME", @"CHARTS", @"PROFILE", @"SETTINGS", nil];
    NSArray *imagesArray   = [[NSArray alloc] initWithObjects:@"home", @"charts", @"profile", @"settings", nil];
